...
\definecolor{awesome}{HTML}{53360000}
...
\email{\href{mailto:faithfrings@gmail.com}{\nolinkurl{faithfrings@gmail.com}}}
\homepage{TBD}
...
\quote{My research focuses on exploring and predicting how course
characteristics and student behaviors impact student learning in coding
biology courses. I am particularly interested in understanding how
student motivation and cognition influences their engagement and success
in these courses. I am also passionate about using data science and
machine learning techniques to analyze large datasets and uncover
patterns that can inform instructional design and curriculum
development.}
...
\begin{cventries}
    \cventry{Covered California}{Information Technology Specialist II}{Sacramento - California}{August 2023 --> Present }{\begin{cvitems}
\item LANGUAGES USED --- T-SQL, Markdown, Python, YAML, HTML, Powershell, Bash, Batch, XML
\item TOOLS USED --- Git, VS Code, Visual Studio, GitHub, SQL Server Management Studio, Anypoint Studio
\item Implemented the MuleSoft Anypoint Platform for Covered California
\end{cvitems}}
    \cventry{Covered California}{Information Technology Specialist I}{Sacramento - California}{March 2022 --> August 2023}{\begin{cvitems}
\item LANGUAGES USED --- T-SQL, Markdown, Python, YAML, HTML, Powershell, Bash, Batch, XML
\item TOOLS USED --- Git, VS Code, Visual Studio, Azure DevOps, SQL Server Management Studio, Anypoint Studio
...
\item My Channel currently has a following of over 220 videos, 47,000 Subscribers, and 3.8 Million Views
\end{cvitems}}
...
\end{cvitems}}
    \cventry{Norseman Leather Works}{Owner \& Operator}{Galt - California}{May 2015 --> January 2023}{\begin{cvitems}
\item LANGUAGES USED --- R, RMarkdown
...
\begin{cventries}
    \cventry{Bachelors Data Analytics \& Data Management}{Western Governors University}{Online}{2020 --> 2023}{}\vspace{-4.0mm}
    \cventry{Statistics I \& II}{American Council on Education - Statistics.com}{Online}{2019 --> 2019}{}\vspace{-4.0mm}
    \cventry{Associate of Art (A.A.) Physical Education Teaching and Coaching}{Cosumnes River College}{Sacramento - California}{2012 --> 2015}{\begin{cvitems}
\item Phi Theta Kappa Academic Honor Society
\end{cvitems}}
    \cventry{Associate of Science (A.S.) Liberal Arts: Math and Science}{Cosumnes River College}{Sacramento - California}{2012 --> 2015}{\begin{cvitems}
\item Phi Theta Kappa Academic Honor Society
\end{cvitems}}
    \cventry{Pre-Calculus}{San Joaquin Delta College}{Stockton - California}{2011 --> 2011}{}\vspace{-4.0mm}
    \cventry{Diploma}{Galt High School}{Galt - California}{2007 --> 2011}{\begin{cvitems}
...
\begin{cventries}
    \cventry{Covered California}{MuleSoft Platform Implementation}{Covered California IT Data Team}{2024}{\begin{cvitems}
\item Implemented the MuleSoft Anypoint Platform for Covered California involving infrastructure and developer tooling such as CICD and GitHub based automation.
\end{cvitems}}
...
\begin{cventries}
    \cventry{Data Analyst Nano Degree}{Udacity}{}{}{\begin{cvitems}
\item Credential ID X5Q95GN4
\end{cvitems}}
    \cventry{IT Information Library Foundations Certification (ITIL)}{AXELOS Global Best Practice}{}{}{\begin{cvitems}
\item Credential ID GR671374467BJ
\end{cvitems}}
    \cventry{}{CompTIA}{}{}{\begin{cvitems}
\item CompTIA A+
\item CompTIA Data+
\item CompTIA Project+
\item CompTIA Network+
\item CompTIA IT Operations Specialist (CIOS)
\end{cvitems}}
    \cventry{}{Lean Six Sigma}{}{}{\begin{cvitems}
\item Green Belt
\item White Belt
\end{cvitems}}
